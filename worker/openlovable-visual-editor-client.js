(() => {
  ...
  function findElementByOpenLovableId(openlovableId, runtimeId) {
  ...
  function handleGetStyles(data) {
    ...
    const element = findElementByOpenLovableId(elementId, runtimeId);
    if (element) {
  ...
  function handleEnableTextEditing(data) {
    ...
    const element = findElementByOpenLovableId(componentId, runtimeId);
    if (element) {
