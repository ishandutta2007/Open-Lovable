(function () {
  console.debug("openlovable-shim.js loaded via proxy v0.6.0");
      ...
      if (url && typeof url === "string") {
        try {
          ...
          if (
            ...
            console.warn(
              "[openlovable-shim] Blocked navigation to unsafe URL protocol:",
              parsedUrl.protocol,
            );
          }
        } catch (e) {
          console.error("[openlovable-shim] Invalid navigation URL:", e);
        }
      } else if (url) {
        console.warn("[openlovable-shim] Invalid URL type:", typeof url);
      } else {
