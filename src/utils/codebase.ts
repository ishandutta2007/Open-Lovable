...
const ALLOWED_EXTENSIONS = [
  ...
  ".swift",
  // Edge cases
  // https://github.com/openlovable-sh/openlovable/issues/880
  ".py",
  // https://github.com/openlovable-sh/openlovable/issues/1221
  ".php",
];
...
//
// ex: https://github.com/openlovable-sh/openlovable/issues/727
const EXCLUDED_DIRS = [
  "node_modules",
  ".git",
  "dist",
...
async function formatFile({
  ...
  try {
    ...
    if (!shouldReadFileContents({ filePath, normalizedRelativePath })) {
      return `<openlovable-file path="${normalizedRelativePath}">
