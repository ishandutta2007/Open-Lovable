...
interface OpenLovableMcpToolCallProps {
  node?: any;
  children?: React.ReactNode;
}

export const OpenLovableMcpToolCall: React.FC<OpenLovableMcpToolCallProps> = ({
  node,
  children,
}) => {
  ...
  return (
    ...
    >
      <OpenLovableCardHeader icon={<Wrench size={15} />} accentColor="blue">
        <OpenLovableBadge color="blue">Tool Call</OpenLovableBadge>
        {serverName && (
