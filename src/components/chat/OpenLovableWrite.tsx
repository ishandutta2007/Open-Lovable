...
interface OpenLovableWriteProps {
  children?: ReactNode;
  node?: any;
  path?: string;
  description?: string;
...
export const OpenLovableWrite: React.FC<OpenLovableWriteProps> = ({
  children,
  node,
  path: pathProp,
  ...
  return (
    ...
    >
      <OpenLovableCardHeader icon={<Pencil size={15} />} accentColor="blue">
        ...
        {inProgress && (
          <OpenLovableStateIndicator state="pending" pendingLabel="Writing..." />
        )}
        {aborted && (
