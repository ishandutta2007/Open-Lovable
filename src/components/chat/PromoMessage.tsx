...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    { type: "link", content: " Get Open-Lovable Pro", url: "https://openlovable.sh/pro#ai" },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Open-Lovable Pro's Smart Context",
      url: "https://openlovable.sh/pro#ai",
    },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Open-Lovable subreddit",
      url: "https://www.reddit.com/r/openlovablebuilders/",
    },
  ],
};
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
      content: " the creator of Open-Lovable build a Bible app step-by-step",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.openlovable.sh/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.openlovable.sh/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.openlovable.sh/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.openlovable.sh/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.openlovable.sh/docs/roadmap",
    },
  ],
};

// Like Open-Lovable? Star it on GitHub https://github.com/openlovable-sh/openlovable/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    {
      type: "text",
      content: "Like Open-Lovable? Star it on ",
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/openlovable-sh/openlovable",
    },
  ],
};
