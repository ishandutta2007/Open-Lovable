...
export function ChatErrorBox({
  ...
  if (error.includes("doesn't have a free quota tier")) {
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        ...
        <span className="ml-1">
          <ExternalLink
            href="https://openlovable.sh/pro?utm_source=openlovable-app&utm_medium=app&utm_campaign=free-quota-error"
            variant="primary"
          >
            Access with Open-Lovable Pro
          </ExternalLink>
        </span>{" "}
  ...
  //
  // Sometimes Open-Lovable Pro can return rate limit errors and we do not want to
    ...
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        ...
        <div className="mt-2 space-y-2 space-x-2">
          <ExternalLink
            href="https://openlovable.sh/pro?utm_source=openlovable-app&utm_medium=app&utm_campaign=rate-limit-error"
            variant="primary"
          >
            Upgrade to Open-Lovable Pro
          </ExternalLink>

          <ExternalLink href="https://openlovable.sh/docs/help/ai-rate-limit">
  ...
  if (error.includes("LiteLLM Virtual Key expected")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          Looks like you don't have a valid Open-Lovable Pro key.{" "}
          <ExternalLink
            href="https://openlovable.sh/pro?utm_source=openlovable-app&utm_medium=app&utm_campaign=invalid-pro-key-error"
            variant="primary"
          >
            Upgrade to Open-Lovable Pro
          </ExternalLink>{" "}
  ...
  if (isOpenLovableProEnabled && error.includes("ExceededBudget:")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          You have used all of your Open-Lovable AI credits this month.{" "}
          <ExternalLink
            href="https://academy.openlovable.sh/subscription?utm_source=openlovable-app&utm_medium=app&utm_campaign=exceeded-budget-error"
            variant="primary"
          >
  ...
  // Example: https://github.com/openlovable-sh/openlovable/issues/1849#issuecomment-3590685911
  ...
  if (error.includes("FREE_AGENT_QUOTA_EXCEEDED")) {
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        ...
        Open-Lovable Pro for unlimited access or switch to Build mode.
        <div className="mt-2 space-y-2 space-x-2">
          <ExternalLink
            href="https://openlovable.sh/pro?utm_source=openlovable-app&utm_medium=app&utm_campaign=free-agent-quota-exceeded"
            variant="primary"
          >
            Upgrade to Open-Lovable Pro
          </ExternalLink>
      ...
      <div className="mt-2 space-y-2 space-x-2">
        {!isOpenLovableProEnabled &&
          ...
          !error.includes("TypeError: terminated") && (
            <ExternalLink
              href="https://openlovable.sh/pro?utm_source=openlovable-app&utm_medium=app&utm_campaign=general-error"
              variant="primary"
            >
              Upgrade to Open-Lovable Pro
            </ExternalLink>
        ...
        <ExternalLink href="https://www.openlovable.sh/docs/faq">
          Read docs
        </ExternalLink>
      </div>
    </ChatErrorContainer>
