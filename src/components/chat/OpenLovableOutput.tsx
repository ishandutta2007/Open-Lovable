...
interface OpenLovableOutputProps {
  type: "error" | "warning";
  message?: string;
  children?: React.ReactNode;
}

export const OpenLovableOutput: React.FC<OpenLovableOutputProps> = ({
  type,
  message,
  children,
}) => {
  ...
  return (
    ...
    >
      <OpenLovableCardHeader icon={icon} accentColor={accentColor}>
        <OpenLovableBadge color={accentColor}>{label}</OpenLovableBadge>
        {message && (
