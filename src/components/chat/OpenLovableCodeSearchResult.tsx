...
interface OpenLovableCodeSearchResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const OpenLovableCodeSearchResult: React.FC<OpenLovableCodeSearchResultProps> = ({
  children,
}) => {
  ...
  return (
    ...
    >
      <OpenLovableCardHeader icon={<FileCode size={15} />} accentColor="indigo">
        <OpenLovableBadge color="indigo">Code Search Result</OpenLovableBadge>
        {files.length > 0 && (
