...
import { OpenLovableTokenSavings } from "./OpenLovableTokenSavings";

interface OpenLovableThinkProps {
  node?: any;
  children?: React.ReactNode;
}

export const OpenLovableThink: React.FC<OpenLovableThinkProps> = ({ children, node }) => {
  ...
  // If it's token savings format, render OpenLovableTokenSavings component
