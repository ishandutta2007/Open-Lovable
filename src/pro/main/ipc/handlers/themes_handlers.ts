...
const THEME_IMAGES_TEMP_DIR = path.join(os.tmpdir(), "openlovable-theme-images");
...
Modern theme extracted from website for testing.
      ...
      // Get API key for Open-Lovable Engine
      ...
      try {
        crawlResponse = await fetch(`${DYAD_ENGINE_URL}/tools/web-crawl`, {
          ...
          headers: {
            ...
            "X-Open-Lovable-Request-Id": `theme-crawl-${uuidv4()}`,
          },
