...
describe("parseFilesFromMessage", () => {
  describe("openlovable-read tags", () => {
    it("should parse a single openlovable-read tag", () => {
      const input = '<openlovable-read path="src/components/Button.tsx"></openlovable-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    });

    it("should parse multiple openlovable-read tags", () => {
      const input = `
        <openlovable-read path="src/components/Button.tsx"></openlovable-read>
        <openlovable-read path="src/utils/helpers.ts"></openlovable-read>
        <openlovable-read path="src/styles/main.css"></openlovable-read>
      `;
      const result = parseFilesFromMessage(input);
    ...
    it("should trim whitespace from file paths in openlovable-read tags", () => {
      const input =
        '<openlovable-read path="  src/components/Button.tsx  "></openlovable-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    ...
    it("should skip empty path attributes", () => {
      const input = `
        <openlovable-read path="src/components/Button.tsx"></openlovable-read>
        <openlovable-read path=""></openlovable-read>
        <openlovable-read path="src/utils/helpers.ts"></openlovable-read>
      `;
      const result = parseFilesFromMessage(input);
      expect(result).toEqual([
    ...
    it("should handle file paths with special characters", () => {
      const input =
        '<openlovable-read path="src/components/@special/Button-v2.tsx"></openlovable-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/@special/Button-v2.tsx"]);
    });
  });

  describe("openlovable-code-search-result tags", () => {
    it("should parse a single file from openlovable-code-search-result", () => {
      const input = `<openlovable-code-search-result>
src/components/Button.tsx
    ...
    it("should parse multiple files from openlovable-code-search-result", () => {
      const input = `<openlovable-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should skip empty lines in openlovable-code-search-result", () => {
      const input = `<openlovable-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should handle multiple openlovable-code-search-result tags", () => {
      const input = `<openlovable-code-search-result>
src/components/Button.tsx
src/components/Input.tsx
</openlovable-code-search-result>
...
src/styles/main.css
  ...
  describe("mixed tags", () => {
    it("should parse both openlovable-read and openlovable-code-search-result tags", () => {
      const input = `
<openlovable-read path="src/config/app.ts"></openlovable-read>
...
<openlovable-read path="src/components/Header.tsx"></openlovable-read>
...
<openlovable-read path="src/config/site.ts"></openlovable-read>
...
`;
  ...
  describe("edge cases", () => {
    ...
    it("should handle malformed tags gracefully", () => {
      const input = `
<openlovable-read path="src/file1.ts"
<openlovable-code-search-result>
src/file2.ts
`;
      const result = parseFilesFromMessage(input);
    ...
    it("should handle nested angle brackets in file paths", () => {
      const input =
        '<openlovable-read path="src/components/Generic<T>.tsx"></openlovable-read>';
      const result = parseFilesFromMessage(input);
...
SRC/COMPONENTS/BUTTON.TSX
    ...
    it("should handle very long file paths", () => {
      ...
      const input = `<openlovable-read path="${longPath}"></openlovable-read>`;
      const result = parseFilesFromMessage(input);
...
describe("processChatMessagesWithVersionedFiles", () => {
  ...
  describe("processing assistant messages", () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'I found this file: <openlovable-read path="src/old.ts"></openlovable-read>',
          providerOptions: {
            "openlovable-engine": {
      ...
      const chatMessages: ModelMessage[] = [
        {
          ...
          content: [
            {
              type: "text",
              text: 'Here is the file: <openlovable-read path="src/array.ts"></openlovable-read>',
            },
            {
              type: "text",
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "user",
          content:
            'Check this: <openlovable-read path="src/user-file.ts"></openlovable-read>',
        },
      ];
      const appPath = "/test/app";
    ...
    it("should skip assistant messages without sourceCommitHash", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'File here: <openlovable-read path="src/no-commit.ts"></openlovable-read>',
          // No providerOptions
        },
        {
          role: "assistant",
          content:
            'Another file: <openlovable-read path="src/no-commit2.ts"></openlovable-read>',
          providerOptions: {
            // openlovable-engine not set
          },
        },
      ];
      const appPath = "/test/app";
  ...
  describe("parsing multiple file paths", () => {
    it("should process multiple files from openlovable-code-search-result", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `<openlovable-code-search-result>
src/file1.ts
src/file2.ts
</openlovable-code-search-result>`,
          providerOptions: {
    ...
    it("should process mixed openlovable-read and openlovable-code-search-result tags", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `
<openlovable-read path="src/file1.ts"></openlovable-read>
  ...
  describe("error handling", () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'Missing file: <openlovable-read path="src/missing.ts"></openlovable-read>',
          providerOptions: {
            "openlovable-engine": {
              sourceCommitHash: "commit1",
            },
    ...
    it("should handle getFileAtCommit throwing an error", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Error file: <openlovable-read path="src/error.ts"></openlovable-read>',
          providerOptions: {
            "openlovable-engine": {
              sourceCommitHash: "commit1",
            },
  ...
  describe("multiple messages", () => {
    it("should process multiple messages with different commits", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        ...
        {
          role: "assistant",
          content: 'Here it is: <openlovable-read path="src/file1.ts"></openlovable-read>',
          providerOptions: {
            "openlovable-engine": {
              sourceCommitHash: "commit1",
            },
        ...
        },
        {
          role: "assistant",
          content:
            'Here it is again: <openlovable-read path="src/file1.ts"></openlovable-read>',
          providerOptions: {
            "openlovable-engine": {
  ...
  describe("integration with files parameter", () => {
    it("should combine files parameter with versioned files from messages", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Old version: <openlovable-read path="src/old.ts"></openlovable-read>',
          providerOptions: {
            "openlovable-engine": {
              sourceCommitHash: "abc123",
            },
