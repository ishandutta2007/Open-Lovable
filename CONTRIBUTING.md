...
Before opening a pull request, please open an issue and discuss whether the change makes sense in Open-Lovable. Ensuring a cohesive user experience sometimes means we can't include every possible feature or we need to consider the long-term design of how we want to support a feature area.

- For a high-level overview of how Open-Lovable works, please see the [Architecture Guide](./docs/architecture.md). Understanding the architecture will help ensure your contributions align with the overall design of the project.
...
- For an in-depth overview of the Open-Lovable codebase, see the DeepWiki documentation [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/openlovable-sh/openlovable)
...
Something that I really appreciate are all the non-code contributions, such as reporting bugs, writing feature requests and participating on [Open-Lovable's sub-reddit](https://www.reddit.com/r/openlovablebuilders).

## Development

Open-Lovable is an Electron app.
...
Open-Lovable relies on several AI code reviewers to catch issues. If a comment is irrelevant please leave a brief comment and mark the comment as resolved.
