...
<openlovable-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
</openlovable-security-finding>

<openlovable-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<openlovable-security-finding title="SQL Injection in User Lookup" level="critical">
...
<openlovable-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<openlovable-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<openlovable-security-finding title="JWT Secret Using Default Value" level="high">
...
<openlovable-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<openlovable-security-finding title="Missing Security Headers" level="low">
